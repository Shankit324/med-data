...
const Home: React.FC<PageProps> = ({ params }: PageProps) => {
  ...
  return (
    <Layout>
      ...
      >
        <h1 style={{ fontSize: "36px", marginBottom: "30px", color: "rgb(40, 102, 69)" }}>Pharmacy Dashboard</h1>
        <div
          style={{
            display: "flex",
            gap: "40px",
        ...
        >
          ...
          >
            <h2>Profile</h2>
            <Link
              href={`/pharmacy/profile/${username}`}
              style={{
                color: "rgb(61, 92, 246)",
                textDecoration: "none",
                fontWeight: "bold",
          ...
          >
            <h2  style={{ fontSize: "20px", marginBottom: "10px" }}>View Bills</h2>
            <Link 
              href={`/pharmacy/view_bills/${username}`}
              style={{
                color: "rgb(61, 92, 246)",
                textDecoration: "none",
                fontWeight: "bold",
